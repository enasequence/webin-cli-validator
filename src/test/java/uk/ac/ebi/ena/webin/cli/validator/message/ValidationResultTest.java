...
public class ValidationResultTest {
  ...
  public void testFormatForReport() {
    ...
    AssertionsForClassTypes.assertThat(formatForReport(error))
        .isEqualTo("ERROR: MESSAGE1 [ORIGIN: TEST]");
    AssertionsForClassTypes.assertThat(formatForReport(info))
        .isEqualTo("INFO: MESSAGE2 [ORIGIN: TEST]");

    origin = new ValidationOrigin("ORIGIN2", "TEST");
    error.appendOrigin(origin);
    info.appendOrigin(origin);
    AssertionsForClassTypes.assertThat(formatForReport(error))
        .isEqualTo("ERROR: MESSAGE1 [ORIGIN: TEST, ORIGIN2: TEST]");
    AssertionsForClassTypes.assertThat(formatForReport(info))
        .isEqualTo("INFO: MESSAGE2 [ORIGIN: TEST, ORIGIN2: TEST]");
  }
  ...
  public void testFormatForLog() {
    ...
    error.appendOrigin(origin);
    info.appendOrigin(origin);
    AssertionsForClassTypes.assertThat(formatForLog(error))
        .isEqualTo("MESSAGE1 [ORIGIN: TEST, ORIGIN2: TEST]");
    AssertionsForClassTypes.assertThat(formatForLog(info))
        .isEqualTo("MESSAGE2 [ORIGIN: TEST, ORIGIN2: TEST]");
  }
