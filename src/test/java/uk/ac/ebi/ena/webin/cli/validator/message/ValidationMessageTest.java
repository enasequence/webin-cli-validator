...
public class ValidationMessageTest {
  ...
  public void testFormat() {
    Assertions.assertThat(new TestMessage("Test {0}").format("TEST")).isEqualTo("Test TEST");
    Assertions.assertThat(new TestMessage("Test {0} {1}").format("TEST1", "TEST2"))
        .isEqualTo("Test TEST1 TEST2");
  }

  @Test
  public void testRegex() {
    Assertions.assertThat(new TestMessage("Test {0}").regex()).isEqualTo("Test .*");
    Assertions.assertThat(new TestMessage("Test {0} {1}").regex()).isEqualTo("Test .* .*");
  }
